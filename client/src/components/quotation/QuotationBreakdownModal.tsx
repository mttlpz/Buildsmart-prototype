...
const SEGMENTS_DATA = [
  { id: 1,  name: "Living Room (A)",  floor: "Main",  sqm: 25.1, color: "#d4a843", practical: { mat:101920, labor:75040, equip:15680, misc:8400  }, premium: { mat:159600, labor:110880, equip:23520, misc:12320 }, ref: "BuildSmart DB v2.4 · PH-WP-MEM-01" },
  { id: 2,  name: "Dining Room (A)", floor: "Main",  sqm: 15.6, color: "#84cc16", practical: { mat:63280,  labor:46480, equip:9800,  misc:5320  }, premium: { mat:99680,  labor:68880,  equip:14560, misc:7840  }, ref: "BuildSmart DB v2.4 · PH-WP-MEM-02" },
  { id: 3,  name: "Kitchen (A)",      floor: "Main",  sqm: 11.1, color: "#f97316", practical: { mat:45080,  labor:33040, equip:7000,  misc:3808  }, premium: { mat:70560,  labor:49280,  equip:10360, misc:5600  }, ref: "BuildSmart DB v2.4 · PH-WP-KIT-01" },
  { id: 4,  name: "Bed 1 (Unit A)",   floor: "Main",  sqm: 18.2, color: "#60a5fa", practical: { mat:73920,  labor:54320, equip:11480, misc:6160  }, premium: { mat:115920, labor:80080,  equip:17080, misc:9240  }, ref: "BuildSmart DB v2.4 · PH-WP-BED-01" },
  { id: 5,  name: "Bed 1 (Unit B)",   floor: "Main",  sqm: 18.2, color: "#818cf8", practical: { mat:73920,  labor:54320, equip:11480, misc:6160  }, premium: { mat:115920, labor:80080,  equip:17080, misc:9240  }, ref: "BuildSmart DB v2.4 · PH-WP-BED-01" },
  { id: 6,  name: "Living Room (B)",  floor: "Main",  sqm: 25.1, color: "#f59e0b", practical: { mat:101920, labor:75040, equip:15680, misc:8400  }, premium: { mat:159600, labor:110880, equip:23520, misc:12320 }, ref: "BuildSmart DB v2.4 · PH-WP-MEM-01" },
  { id: 7,  name: "Dining Room (B)", floor: "Main",  sqm: 15.6, color: "#65a30d", practical: { mat:63280,  labor:46480, equip:9800,  misc:5320  }, premium: { mat:99680,  labor:68880,  equip:14560, misc:7840  }, ref: "BuildSmart DB v2.4 · PH-WP-MEM-02" },
  { id: 8,  name: "Kitchen (B)",      floor: "Main",  sqm: 11.1, color: "#ea580c", practical: { mat:45080,  labor:33040, equip:7000,  misc:3808  }, premium: { mat:70560,  labor:49280,  equip:10360, misc:5600  }, ref: "BuildSmart DB v2.4 · PH-WP-KIT-01" },
  { id: 9,  name: "Garage",           floor: "Main",  sqm: 40.9, color: "#9ca3af", practical: { mat:166040, labor:122080,equip:25760, misc:13720 }, premium: { mat:259840, labor:180320, equip:38360, misc:20440 }, ref: "BuildSmart DB v2.4 · PH-WP-GAR-01" },
  { id: 10, name: "Deck",             floor: "Main",  sqm: 14.9, color: "#fbbf24", practical: { mat:60480,  labor:44520, equip:9408,  misc:5040  }, premium: { mat:94640,  labor:65800,  equip:13888, misc:7448  }, ref: "BuildSmart DB v2.4 · PH-WP-DEC-01" },
  { id: 11, name: "Family Room (A)",  floor: "Lower", sqm: 23.8, color: "#2dd4bf", practical: { mat:96600,  labor:71120, equip:15008, misc:8008  }, premium: { mat:151200, labor:105000, equip:22288, misc:11760 }, ref: "BuildSmart DB v2.4 · PH-WP-FAM-01" },
  { id: 12, name: "Game Area (A)",    floor: "Lower", sqm: 26.8, color: "#34d399", practical: { mat:108752, labor:80080, equip:16856, misc:9016  }, premium: { mat:170240, labor:118160, equip:25088, misc:13216 }, ref: "BuildSmart DB v2.4 · PH-WP-REC-01" },
  { id: 13, name: "Game Area (B)",    floor: "Lower", sqm: 26.8, color: "#10b981", practical: { mat:108752, labor:80080, equip:16856, misc:9016  }, premium: { mat:170240, labor:118160, equip:25088, misc:13216 }, ref: "BuildSmart DB v2.4 · PH-WP-REC-01" },
  { id: 14, name: "Bed 2 (Unit A)",   floor: "Lower", sqm:  5.9, color: "#5eead4", practical: { mat:23968,  labor:17640, equip:3696,  misc:1960  }, premium: { mat:37520,  labor:26040,  equip:5488,  misc:2912  }, ref: "BuildSmart DB v2.4 · PH-WP-BED-02" },
  { id: 15, name: "Bed 3 (Unit A)",   floor: "Lower", sqm:  5.9, color: "#38bdf8", practical: { mat:23968,  labor:17640, equip:3696,  misc:1960  }, premium: { mat:37520,  labor:26040,  equip:5488,  misc:2912  }, ref: "BuildSmart DB v2.4 · PH-WP-BED-02" },
  { id: 16, name: "Bed 2 (Unit B)",   floor: "Lower", sqm:  5.9, color: "#7dd3fc", practical: { mat:23968,  labor:17640, equip:3696,  misc:1960  }, premium: { mat:37520,  labor:26040,  equip:5488,  misc:2912  }, ref: "BuildSmart DB v2.4 · PH-WP-BED-02" },
  { id: 17, name: "Crawl Space",      floor: "Lower", sqm: 11.1, color: "#a3e635", practical: { mat:45080,  labor:33040, equip:7000,  misc:3808  }, premium: { mat:70560,  labor:49280,  equip:10360, misc:5600  }, ref: "BuildSmart DB v2.4 · PH-WP-CRAWL-01" },
];

const BOQ_ITEMS = [
  { code: "WP-MEM-STD",  description: "Waterproofing Membrane (Standard)",  unit: "m²",  qtyP: 302, rateP: 1596,   qtyPr: 302, ratePr: 2509  },
  { code: "WP-MEM-FLT",  description: "Membrane Flashing (perimeter)",      unit: "lm",  qtyP: 184, rateP: 683,    qtyPr: 184, ratePr: 1098  },
  { code: "PRM-COAT",    description: "Primer Coat Application",            unit: "m²",  qtyP: 302, rateP: 325,    qtyPr: 302, ratePr: 470   },
  { code: "LAB-WP",      description: "Labour – Waterproofing Crew",        unit: "hr",  qtyP: 480, rateP: 1960,   qtyPr: 400, ratePr: 3206  },
  { code: "EQP-TORCH",   description: "Equipment – Torch & Heat Welder",    unit: "day", qtyP:  14, rateP: 4760,   qtyPr:  10, ratePr: 8120  },
  { code: "EQP-PUMP",    description: "Equipment – Pressure Test Pump",     unit: "day", qtyP:   6, rateP: 3640,   qtyPr:   6, ratePr: 3640  },
  { code: "SEALANT",     description: "Sealant & Gap Filler",               unit: "tube",qtyP:  48, rateP: 476,    qtyPr:  48, ratePr: 795   },
  { code: "DRAIN-GRATE", description: "Drainage Grates & Covers",           unit: "pc",  qtyP:  12, rateP: 1792,   qtyPr:  12, ratePr: 3248  },
  { code: "SCAFFOLD",    description: "Scaffolding (erect & dismantle)",    unit: "ls",  qtyP:   1, rateP: 103600, qtyPr:   1, ratePr: 103600 },
  { code: "CLEANUP",     description: "Post-work Clean-up & Disposal",      unit: "ls",  qtyP:   1, rateP: 38080,  qtyPr:   1, ratePr: 38080  },
  { code: "INSP",        description: "Site Inspection & QA Testing",       unit: "ls",  qtyP:   1, rateP: 53200,  qtyPr:   1, ratePr: 92400  },
  { code: "MISC",        description: "Contingency & Miscellaneous",        unit: "ls",  qtyP:   1, rateP: 121520, qtyPr:   1, ratePr: 182000 },
];

interface BenchmarkItem { code: string; name: string; specP: string; specPr: string; catalogMatch: string; catalogPrice: number; quoted: number; saving: number; edited?: string; }

const BENCHMARK_DATA: BenchmarkItem[] = [
  { code: "WP-MEM-STD",  name: "Waterproofing Membrane",  specP: "Sika 2K-PU Standard 2mm",  specPr: "Tremco ExoAir 430 Premium",   catalogMatch: "Mapei Mapelastic 1.5mm", catalogPrice: 1277,  quoted: 1596, saving: 319  },
  { code: "WP-MEM-FLT",  name: "Membrane Flashing",       specP: "Ardex WPM 300 (std)",       specPr: "Ardex WPM 300 (prem)",         catalogMatch: "Fosroc Nitobond AR",     catalogPrice: 588,   quoted: 683,  saving: 95   },
  { code: "PRM-COAT",    name: "Primer Coat",              specP: "Sika Primer 3N",             specPr: "Tremco Primer 55",              catalogMatch: "Mapei Eco Prim Grip",    catalogPrice: 235,   quoted: 325,  saving: 90   },
  { code: "SEALANT",     name: "Sealant & Gap Filler",     specP: "Selleys All Clear",          specPr: "Tremco Spectrem 2",             catalogMatch: "Bostik Seal N Flex",     catalogPrice: 386,   quoted: 476,  saving: 90   },
  { code: "DRAIN-GRATE", name: "Drainage Grates",          specP: "Reln Slotted (poly)",        specPr: "Stainless 316 Grade",           catalogMatch: "ACO Drain Channel",      catalogPrice: 1596,  quoted: 1792, saving: 196  },
];
    ...
    <div className="overflow-x-auto">
      <table className="w-full text-xs">
        ...
        <tbody>
          ...
          {/* Expanded detail rows rendered separately to avoid fragment-inside-tbody issues */}
          {SEGMENTS_DATA.filter(seg => expanded === seg.id).map((seg) => (
  ...
  return (
    <div>
                  ...
                  {isEditing ? (
                    <div className="flex items-center gap-1">
                      <input value={draft} onChange={(e) => setDraft(e.target.value)}
                        ...
                        placeholder="Enter spec…" autoFocus />
                      <button onClick={() => { setEdits((p) => ({ ...p, [item.code]: draft })); setEditing(null); }}
                        className="rounded bg-[#E07B39] p-0.5 text-white"><Check className="h-3 w-3" /></button>
                    </div>
                  ) : (
      ...
      <div className="mt-4 rounded-xl border border-green-100 bg-green-50 p-3 text-sm">
        ...
        <p className="text-green-700">Substituting all catalog alternatives saves approximately <strong>{fmt(BENCHMARK_DATA.reduce((s, i) => s + i.saving * 302 * 0.032, 0))}</strong> on this quote.</p>
      </div>
    </div>
  );
}
...
function ComparisonTab() {
  const pTotal = 2_537_920; const prTotal = 3_799_600;
  const rows = [
    { label: "Total Cost",         p: fmt(pTotal),           pr: fmt(prTotal),             note: `Premium is ${Math.round((prTotal/pTotal-1)*100)}% more` },
    { label: "Cost per sqm",       p: fmt(pTotal/302),       pr: fmt(prTotal/302),          note: `+${fmt((prTotal-pTotal)/302)} per sqm` },
    ...
    { label: "Materials Cost",     p: fmt(1_240_400),        pr: fmt(1_915_200),            note: `+${fmt(674800)}` },
    { label: "Labor Cost",         p: fmt(940_800),          pr: fmt(1_282_400),            note: `+${fmt(341600)}` },
    { label: "Equipment Cost",     p: fmt(235_200),          pr: fmt(420_000),              note: `+${fmt(184800)}` },
    { label: "Miscellaneous",      p: fmt(121_520),          pr: fmt(182_000),              note: `+${fmt(60480)}` },
      ...
      <div className="mb-4 grid grid-cols-3 gap-3">
        {[
          ...
          <div key={i} className={`${i === 1 ? "flex items-center justify-center" : "rounded-xl p-3"}`}
            ...
            {i === 1 ? <span className="text-lg font-bold text-gray-400">VS</span> : (
              <><p className="text-sm font-bold" style={{ color: h.color }}>{h.label}</p><p className="text-xs text-gray-500">{h.desc}</p></>
            )}
          </div>
        ))}
      </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="flex h-[92vh] w-[96vw] max-w-7xl flex-col rounded-2xl bg-white shadow-2xl overflow-hidden">
        ...
        <div className="flex flex-shrink-0 items-center justify-between border-b border-gray-200 bg-gray-50 px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex overflow-hidden rounded-lg border border-gray-200 bg-white text-xs">
              {(["practical", "premium"] as QuoteType[]).map((q) => (
                <button key={q} onClick={() => setSelectedQuote(q)}
          ...
          <button data-testid="btn-close-breakdown" onClick={onClose}
        ...
        <div className="flex flex-shrink-0 border-b border-gray-200 bg-white px-6">
          {TABS.map((tab) => {
            const Icon = tab.icon;
            return (
              <button key={tab.id} data-testid={`breakdown-tab-${tab.id}`}
